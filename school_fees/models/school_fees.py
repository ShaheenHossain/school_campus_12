...
class StudentPayslip(models.Model):
	...
	def onchange_student(self):
		...
		if self.student_id:
			...
			fees_structure = self.env['student.fees.structure'].search([('semester_id','=',self.student_id.semester_id.id)], limit=1)
			print ("===========fees_structure",fees_structure,self.student_id.semester_id.id)
