		...
		for x in self:
			if len(str(x.nid))==10:
				...
				if res:
					...
					raise UserError(_("Please Check your Tazkira Number"))
			else:
				raise UserError(_("Invlid  Your Tazkira Number"))
...
#Developer 2
	...
	feedback_count = fields.Integer('Number of Feedback', compute='_feedback_count')
